...
export function Mario(canva, width, height) {
  var TAU = Math.PI * 2
  ...
  var w = 72
  var h = 72
  var minWindowSize = Math.min(canvas.width, canvas.height)
  ...
  ;[-1, 1].forEach(function(xSide) {
    ...
    new Shape({
      path: [{ x: 4.5 * xSide, y: -4.5, z: -11.75 }],
      color: colors.hair,
      fill: true,
      lineWidth: 4,
      addTo: mustacheGroup,
    ...
    // hair balls
    new Shape({
      path: [{ x: 6 * xSide, y: -4, z: 7 }],
      color: colors.hair,
      lineWidth: 6,
      addTo: camera,
    })
    new Shape({
      path: [{ x: 2 * xSide, y: -4, z: 9 }],
      color: colors.hair,
      lineWidth: 6,
      addTo: camera,
    })
  ...
  new Shape({
    path: [rightShoulder, { x: -14, y: -7, z: -1 }],
    color: colors.cloth,
    lineWidth: 8,
    addTo: camera,
  })
